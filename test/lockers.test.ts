...
describe("Lockers", async () => {
    ...
    describe("#buySlashedCollateralOfLocker", async () => {
        ...
        it("can buy slashing amount (native token)", async function () {
        ...
        it("can buy slashing amount (custom token)", async function () {
    ...
    describe("#mint", async () => {
        ...
        it("Mints core BTC (CustomToken collateral)", async function () {
    ...
    describe("#liquidateLocker", async () => {
        ...
        it("successfully liquidate the locker (CustomToken collateral) ", async function () {
    ...
    describe("#removeCollateral", async () => {
        ...
        it("remove collateral successfully (custom token)", async function () {
